...
urlpatterns = [
   ...
   path('subjects/<str:name>/edit/', views.subject_edit, name='subject_edit'),
   ...
   path('<str:title>/edit/', views.exam_edit, name='exam_edit'),
...
path('exams/<int:pk>/download-pdf/', views.exam_download_pdf, name='exam_download_pdf'),
 path("plans/", views.plan_list, name="plan_list"),
    ...
    path("plans/<str:name>/edit/", views.plan_update, name="plan_update"),
